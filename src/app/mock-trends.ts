...
export const TRENDS: Trend[]=[
    ...
    {name: 'AI for Everybody', description:'',trend_stage:''},
    {name: 'Deep Learning Theory', description:'',trend_stage:''},
    {name: 'Deep Reinforcement Learning', description:'',trend_stage:''},
    {name: 'Generative Adversarial Networks', description:'',trend_stage:''},
    {name: 'Lean and Augmented Data Learning', description:'',trend_stage:''},
    {name: 'Probabilistic Programming', description:'',trend_stage:''},
    {name: 'Hybrid Learning Models', description:'',trend_stage:''},
    {name: 'Automated Machine Learning', description:'',trend_stage:''},
    {name: 'Ethereum', description:'',trend_stage:''},
    {name: 'Hyperledger', description:'',trend_stage:''},
    {name: 'IOTA -The Tangle', description:'',trend_stage:''},
    {name: 'Multichain', description:'',trend_stage:''},
    {name: 'Digital Twin', description:'',trend_stage:''},
    {name: 'Explainable AI', description:'',trend_stage:''},
    {name: 'Sensing City', description:'',trend_stage:''},
    {name: 'Computer Vision', description:'',trend_stage:''},
    {name: 'Quantum Computing ', description:'',trend_stage:''},
    {name: 'Cardano', description:'',trend_stage:''},
    {name: 'Enigma', description:'',trend_stage:''},
    {name: 'Hashgraph', description:'',trend_stage:''},
    {name: 'Paxos', description:'',trend_stage:''},
    {name: 'Raft', description:'',trend_stage:''},
    {name: 'EOS', description:'',trend_stage:''},
    {name: 'Basic Attention Token', description:'',trend_stage:''},
    {name: 'Nomadic Blockchain', description:'',trend_stage:''},
    {name: 'ECR 712', description:'',trend_stage:''},
    {name: 'Token Curated Registries', description:'',trend_stage:''},
    {name: 'Prediction Markets', description:'',trend_stage:''},
    {name: 'Digital Asset Markup Language', description:'',trend_stage:''},
    {name: 'Blockchain backed financial servicec', description:'',trend_stage:''},
    {name: 'Peer to peer marketplaces', description:'',trend_stage:''},
    {name: 'Trusted Timestamping', description:'',trend_stage:''},
    {name: 'Zero Knowledge proof with Blockchain', description:'',trend_stage:''},
    {name: 'Blockchain for IoT', description:'',trend_stage:''},
    {name: 'Blockchain in Supply Chain Management', description:'',trend_stage:''},
    {name: 'Physical Access control via Blockchain', description:'',trend_stage:''},
    {name: 'Digital Identity and Access Management using Blockchain', description:'',trend_stage:''}
